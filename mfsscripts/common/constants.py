...
# FUSE / path ops used by treemap (and potentially other views)
CLTOMA_PATH_LOOKUP         = (PROTO_BASE+390)
MATOCL_PATH_LOOKUP         = (PROTO_BASE+391)
CLTOMA_FUSE_GETATTR        = (PROTO_BASE+408)
MATOCL_FUSE_GETATTR        = (PROTO_BASE+409)
CLTOMA_FUSE_READDIR        = (PROTO_BASE+428)
MATOCL_FUSE_READDIR        = (PROTO_BASE+429)
...
STATE_DEPUTY      = 0x05
STATE_MASTERCE    = 0xFF
STATE_STR_WRONGANSWER = "WRONG ANSWER"
